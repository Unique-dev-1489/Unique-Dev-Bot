...
import os 
API_KEY = os.getenv("8344444166:AAG22UCnHbvbs6qAyztnmIW9p2Zpix3NYnE")
...
def handle_start(message):
    ...
    bot.send_message(message.chat.id,
        "Welcome to the *Unique Dev Bot!*\n"
        "I can help you auto-reply in your Telegram group using keywords.\n\n"
        "➤ Subscribe to our YouTube Channel: https://youtube.com/@uniquedevoloper?si=y6nYDmJtpllJe4wC\n\n"
